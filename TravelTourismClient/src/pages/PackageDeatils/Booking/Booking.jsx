        ...
        <div className='bg-base-100 shadow-2xl card'>
          <form onSubmit={handleBooking} className='card-body'>
            <div className='gap-4 grid grid-cols-2'>
              <div>
                <label htmlFor='tourist_name' className='block mb-2'>
                  Tourist Name
                </label>
                <input
                  disabled
              ...
              <div>
                <label htmlFor='tourist_email' className='block mb-2'>
                  Tourist Email
                </label>
                <input
                  disabled
              ...
              <div>
                <label htmlFor='tourist_image' className='block mb-2'>
                  Tourist Image URL
                </label>
                <input
                  disabled
              ...
              <div>
                <label htmlFor='guide' className='block mb-2'>
                  Tour Guide Email:
                </label>
                <select
                  id='guide'
            ...
            <div className='md:col-span-2'>
              <button
                type='submit'
                className='bg-sky-600 hover:bg-sky-700 py-3 rounded-md w-full font-semibold text-white transition'
              >
                Book Now
              </button>
            </div>
          ...
          {showCongratulations && (
            <div className='flex justify-center items-center mt-4'>
              <Confetti />
              <div className='bg-green-100 mx-auto p-4 border-green-500 border-l-4 w-full max-w-sm text-green-700'>
                <p className='font-bold'>Congratulations!</p>
                <p>
                  You have booked more than 3 times. You qualify for a discount.
                </p>
                <button className='bg-blue-500 hover:bg-blue-600 mt-2 px-3 py-1 rounded focus:outline-none text-white'>
                  Apply Discount
                </button>
              </div>
            </div>
        ...
        >
          <div className='modal-box'>
            ...
            <Link to='/dashboard/mybooking'>
              <button className='btn btn-accent'>My Booking Page</button>
            </Link>
