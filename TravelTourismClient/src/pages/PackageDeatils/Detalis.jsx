...
const Detalis = () => {
  ...
  return (
    <div className='flex flex-col justify-center items-center pb-12 package-details'>
      <h1 className='pt-20'>{trip_title}</h1>
      <p className='tour-type'>{tour_type}</p>
      <p className='price'>${price}</p>

      <h1 className='pb-12 font-black text-4xl text-center text-sky-600'>
        Gallery
      </h1>
      <Gallery images={images}></Gallery>

      <div className='description'>
        <h1 className='pt-12 pb-10 font-black text-4xl text-center text-sky-600'>
          About the Trip
        </h1>
        <p>{description}</p>
      </div>

      <h1 className='pt-12 font-black text-4xl text-center text-sky-600'>
        Tour Plan
      </h1>
