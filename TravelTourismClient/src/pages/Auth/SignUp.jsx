        ...
        <div className=''>
          ...
          <div className='bg-base-100 shadow-2xl card lg:card-side'>
            <div className='lg:w-[52%] lg:h-[60%]'>
              <img
                className='lg:pt-72 w-full h-96 lg:h-full'
                src={authpic}
                alt=''
              />
            </div>
            <form onSubmit={handleSubmit(onSubmit)} className='card-body'>
              ...
              <div className='form-control'>
                ...
                />
                {errors.education && (
                  <span className='text-red-600'>education is required</span>
                )}
              </div>
              <div className='form-control'>
                <label className='label'>
                ...
                />
                {errors.skill && (
                  <span className='text-red-600'>skill is required</span>
                )}
              </div>
              <div className='form-control'>
                <label className='label'>
                ...
                />
                {errors.work && (
                  <span className='text-red-600'>work is required</span>
                )}
              </div>
              <div className='form-control'>
                <label className='label'>
